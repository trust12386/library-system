    ...
    <view class="box">
      <view class="box-title">
        ...
        <view class="title_bottom">
          <view class="title_left">{{ city.name }}</view>
